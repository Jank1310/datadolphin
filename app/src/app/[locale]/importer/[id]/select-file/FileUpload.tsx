    ...
    <div>
      ...
      {file && (
        <div className="mt-4 flex flex-col">
          {file.type === "text/csv" && (
            <>
              <Label className="mb-2">{t("select-file.uploader.delimiter.placeholder")}</Label>
              <Select
              ...
              >
                <SelectTrigger>
                  <SelectValue placeholder={t("select-file.uploader.delimiter.placeholder")} />
                </SelectTrigger>
                <SelectContent>
                  <SelectGroup>
                    <SelectItem value=","> {t("select-file.uploader.delimiter.comma")}</SelectItem>
                    <SelectItem value=";">{t("select-file.uploader.delimiter.semicolon")}</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
            </>
