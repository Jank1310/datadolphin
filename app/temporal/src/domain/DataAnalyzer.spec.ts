...
describe("DataAnalyzer", () => {
    ...
    it("should get correct mapping recommendations", () => {
        const sourceColumns: string[] = ["name", "name2", "age", "position", "mail", "role", "salry"];

        const result = analyzer.generateMappingRecommendations(sourceColumns, columnConfigs);
    ...
    describe("validation", () => {
        it("should validate required columns", () => {
            ...
            const stats = {};
            const result = analyzer.processDataValidations(rowsWithMissingName, validatorColumns, stats);
            expect(result).toEqual([
                {
        ...
        it("should validate unique columns", () => {
            ...
            const result = analyzer.processDataValidations(rowsWithDuplicateValues, validatorColumns, stats);
            expect(result).toEqual([
                {
        ...
        it("should validate regex columns", () => {
            ...
            const stats = {};
            const result = analyzer.processDataValidations(rowsWithRegexValues, validatorColumns, stats);
            expect(result).toEqual([
                {
                    rowId: "65b39818ab8b36794717db1c",
                    column: "Postleitzahl",
        ...
        it("should validate email columns", () => {
            ...
            const stats = {};
            const result = analyzer.processDataValidations(rowsWithEmailValues, validatorColumns, stats);
            expect(result).toEqual([
                {
                    rowId: "65b39818ab8b36794717db1c",
                    column: "email",
        ...
        it("should validate all validations", () => {
            ...
            const result = analyzer.processDataValidations(rows, validatorColumns, stats);
            expect(result).toEqual([
                {
                    rowId: "65b39818ab8b36794717db1a",
                    column: "name",
        ...
        it("should validate enum values", () => {
            ...
            const stats = {};
            const result = analyzer.processDataValidations(rowsWithValues, validatorColumns, stats);
            expect(result).toEqual([
                {
                    column: "department",
                    rowId: "65b39818ab8b36794717db1c",
